...
function YNconfirm() {
    ...
    <form action = "admin_user.php" method="POST">
        ...
        <?php
            ...
            if($u->hasPrivilege("m_user")){

            // sending query
            $result = mysqli_query($conn,"SELECT USER_ID, USERNAME,  USER_FNAME, USER_MNAME, USER_LNAME, USER_GENDER, USER_BDAY, USER_CONTACT FROM user WHERE user_type = 'Artist' OR user_type = 'Customer'");
            if (!$result) {
                    ...
                    // printing table rows
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo '<td class="table-data">'.$row[0].'</td>
                                ...
                                ';
                            echo '<td><a class="editbtn" href =edituser.php?id='.$row[0].'> Modify</a><br>  <a class="delbutton" href="admin_deleteuser.php?id='.$row[0].'" onclick="return(YNconfirm());">Delete</a></td>';
                            echo "</tr>\n";
