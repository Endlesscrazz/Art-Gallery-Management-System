                            ...
                            <table  class="pic-table">
                                <tr>
                                    <td style="padding:10px;">
                                        ...
                                        if($u->hasPrivilege("modify_art")){

                                          echo      '<a class="modifybtn" href="edit_artwork.php?category='.$row['art_category'].'&id='.$row['art_id'].'"> &#128393; Modify </a>';

                                        }

                                        if($u->hasPrivilege("delete_art")){

                                          echo      '<a class="deletebtn" href =delete_artwork_action.php?delete='.$row['art_id'].'&pic='.$row['art_imagepath'].' onclick="return(YNconfirm());"> &#10006; Delete</a>

                                                <br><br><br>';

                                        }

                                        if($u->hasPrivilege("add_to_exhi")){

                                          echo       '<a class="deletebtn" href =add_to_exhibition.php?exhibition='.$row['art_id'].'&pic='.$row['art_imagepath'].'> &#10010; Add To Exhibition</a>';
